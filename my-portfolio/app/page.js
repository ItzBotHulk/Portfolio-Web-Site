    ...
    <>
      <section className="md:grid md:grid-cols-2 md:mt-[23vh] mt-20 w-full max-w-[100vw] overflow-x-hidden grid-cols-1">
        <div className="avatar flex justify-center items-center">
          <img className="md:w-[600px] w-64" src="/img/avatar.png" alt="avatar" />
        </div>
      ...
      <main className="text-white ">
        ...
        <div className="w-screen lg:ml-[13vw] w-full max-w-[100vw] overflow-x-hidden">
            ...
            <div className="certificat lg:flex my-10  lg:justify-center lg:items-center rounded-xl bg-[#190634] lg:w-[70vw] max-w-[80vw] w-80  h-[55vh] lg:max-h-[30vh] textglow ">
              <div className="logo flex justify-center items-center">
                <Link href='https://hashtrust.in/' target="_blank">
                  <img src="/img/logo.png" className=" hover:invert-50 rounded-xl my-10 " alt="logo" width={250} />
                </Link>
              </div>
              ...
              <div className="invert-100 justify-evenly flex my-10 lg:pl-32">
                ...
                <Link href='https://hashtrust.in/' target="_blank"><img
                  className="invert-100 lg:ml-5 lg:mr-10" src="/bgs/click.png" width={20} alt="click" /></Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="slider glow mt-20 opacity-85 w-full max-w-[100vw] overflow-x-hidden">
          <div className=" slideTrack flex items-center justify-center">
            ...
            <div className="slide"><img className="invert-100" src="/img/nextjs.svg" alt="img" width={50} /></div>
            <div className="slide"><img src="/img/nodejs.svg" alt="img" width={50} /></div>
            <div className="slide"><img className="invert-100" src="/img/express.svg" alt="img" width={50} /></div>
            ...
            <div className="slide"><img className="invert-100" src="/img/django.svg" alt="img" width={50} /></div>
            ...
            <div className="slide"><img className="invert-100" src="/img/github.svg" alt="img" width={50} /></div>
            {/* duplicate for loop */}
            <div className="slide"><img src="/img/html.svg" alt="html" width={50} /></div>
            <div className="slide"><img src="/img/css.svg" alt="img" width={50} /></div>
            <div className="slide"><img src="/img/javaScript.svg" alt="img" width={50} /></div>
